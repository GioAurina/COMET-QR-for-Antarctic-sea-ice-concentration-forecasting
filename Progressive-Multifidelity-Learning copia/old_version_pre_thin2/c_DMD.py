...
save_path_filtered = os.path.join(CHECKPOINTS_DIR, f'dmd_fits_FILTERED_rank{rank}_bootstrap{N_boot_strap}_years2-34.pkl')
...
forecast_save_path = os.path.join(CHECKPOINTS_DIR, f'dmd_forecasts_rank{rank}_bootstrap{N_boot_strap}_years2-34.pkl')
